...
public interface KeyValueCategoryMapper {
	...
	List<KeyValueCategory> selectAllKeyValue(Short categoryStatus,Short itemStatus);
	
	List<KeyValueCategory> selectAllCategoryWithItem(@Param("categoryStatus") Short categoryStatus,
			@Param("itemStatus") Short itemStatus,@Param("categoryName") String categoryName);
}