...
public class HttpConstant {
	...
	public static final int REFRESHTOKENEXPIRESUTC = 1;//天/单位
	...
	public static final String LOGIN_CONFUSION_STR="SUNLIGHT_IAS_AIM_Marketing";
	public static final String PASSWORD_SALT="sdt.admin";
	public static final String AIM_MARKETING_LOGIN_COOKIE = "sdt.aim.marketing.login";
	public static final String AIM_MARKETING_USERID_COOKIE = "sdt.aim.marketing.user";
	public static final String AIM_MARKETING_USERNAME_COOKIE = "sdt.aim.marketing.name";
	public static final String AIM_MARKETING_ENTERPRISEID_COOKIE = "sdt.aim.marketing.enterprise";
	
	public static final String AIM_MARKETING_ADMIN_LOGIN_COOKIE = "sdt.aim.marketing.admin.login";
	public static final String AIM_MARKETING_ADMIN_USER_NAME_COOKIE = "sdt.aim.marketing.admin.user.name";
	public static final String AIM_MARKETING_ADMIN_USER_ID_COOKIE = "sdt.aim.marketing.admin.user.id";
